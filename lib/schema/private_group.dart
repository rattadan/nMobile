...
import 'package:nchat_mobile/utils/map_extension.dart';
...
class PrivateGroupSchema {
  ...
  int get lastAvatarBroadcastAt {
    return int.tryParse(data['last_avatar_broadcast_at']?.toString() ?? "0") ?? 0;
  }
  ...
  int get lastAvatarReceivedAt {
    return int.tryParse(data['last_avatar_received_at']?.toString() ?? "0") ?? 0;
  }
