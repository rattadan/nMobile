...
import 'package:nchat_mobile/components/private_group/avatar_editable.dart';
  ...
  void _initializeActions() {
    _actions = [
      ...
      SlideoutActionItem(
        ...
        onTap: () {
          if (_privateGroup != null) {
            ChatMessagesScreen.go(context, _privateGroup!);
          }
        },
      ),
      SlideoutActionItem(
        ...
        onTap: () {
          if (_privateGroup != null) {
            Util.copyText(_privateGroup!.groupId);
          }
        },
      ),
    ];
