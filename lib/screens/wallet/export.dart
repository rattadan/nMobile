...
import 'package:nchat_mobile/components/wallet/avatar.dart';
...
class WalletExportScreen extends BaseStateFulWidget {
  ...
  static Future go(
    ...
    logger.d(
        "WalletExportScreen - go - type:$walletType  name:$name \n address:$address");
...
class _WalletExportScreenState
    extends BaseStateFulWidgetState<WalletExportScreen> {
  String? _walletType;
  String? _name;
  String? _address;
  String? _publicKey;
                    ...
                    child: Column(
                      children: <Widget>[
                        Padding(
                          ...
                          child: Button(
                            child: Label(
                              Settings.locale((s) => s.view_qrcode,
                                  ctx: context),
                              type: LabelType.h3,
                            ...
                            onPressed: () {
                              BottomDialog.of(Settings.appContext).showQrcode(
                                title: Settings.locale((s) => s.seed) +
                                    Settings.locale((s) => s.qrcode),
