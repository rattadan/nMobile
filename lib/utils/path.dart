...
class Path {
  ...
  static String joinFileExt(String filePath, String? fileExt) {
    if (fileExt == null || fileExt.isEmpty) {
      ...
      int index = party[(party.length - 1) >= 0 ? party.length - 1 : 0]
          .lastIndexOf(".");
      if (index < 0) {
  ...
  static Future<String> createDir(String? uid, String? dirType,
  ...
  static Future<String> getFile(String? uid, String? dirType, String fileName,
      {String? subPath, String? fileExt}) async {
  ...
  static Future<String> createFile(
      String? uid, String? dirType, String fileName,
      {String? subPath, String? fileExt, bool reCreate = true}) async {
    String filePath = await getFile(uid, dirType, fileName,
  ...
  static Future<String> getRandomFile(String? uid, String dirType,
      {String? subPath, String? fileExt}) async {
    String fileName = new DateTime.now().millisecondsSinceEpoch.toString() +
        '_temp_' +
        Uuid().v4();
    return await getFile(uid, dirType, fileName,
        subPath: subPath, fileExt: fileExt);
  }

  static Future<String> createRandomFile(String? uid, String dirType,
      {String? subPath, String? fileExt, bool reCreate = true}) async {
    String filePath =
        await getRandomFile(uid, dirType, subPath: subPath, fileExt: fileExt);
    File file = File(filePath);
    if (file.existsSync()) {
      if (reCreate) {
        await file.delete();
  ...
  static String? convert2Local(String? completePath) {
    ...
    String rootDir = Settings.applicationRootDirectory.path.endsWith("/")
        ? Settings.applicationRootDirectory.path
        : (Settings.applicationRootDirectory.path + "/");
