...
class S {
  ...
  /// `nMobile`
  String get app_name {
    return Intl.message('nMobile', name: 'app_name', desc: '', args: []);
  }

  /// `D-Chat`
  String get d_chat {
    return Intl.message('D-Chat', name: 'd_chat', desc: '', args: []);
  }
  ...
  String get menu_chat {
    return Intl.message('D-Chat', name: 'menu_chat', desc: '', args: []);
  }
  ...
  String get menu_wallet {
    return Intl.message('Account', name: 'menu_wallet', desc: '', args: []);
  }

  /// `News`
  String get menu_news {
    return Intl.message('News', name: 'menu_news', desc: '', args: []);
  }
  ...
  String get top_cancel {
    return Intl.message('Cancel Top', name: 'top_cancel', desc: '', args: []);
  }
  ...
  String get language_auto {
    return Intl.message('Auto', name: 'language_auto', desc: '', args: []);
  }
  ...
  String get contact_us {
    return Intl.message('Contact', name: 'contact_us', desc: '', args: []);
  }
  ...
  /// `MAINNET`
  String get mainnet {
    return Intl.message('MAINNET', name: 'mainnet', desc: '', args: []);
  }

  /// `NKN`
  String get nkn {
    return Intl.message('NKN', name: 'nkn', desc: '', args: []);
  }
  ...
  /// `ERC-20`
  String get ERC_20 {
    return Intl.message('ERC-20', name: 'ERC_20', desc: '', args: []);
  }

  /// `GWEI`
  String get gwei {
    return Intl.message('GWEI', name: 'gwei', desc: '', args: []);
  }
  ...
  /// `Max Gas`
  String get gas_max {
    return Intl.message('Max Gas', name: 'gas_max', desc: '', args: []);
  }

  /// `NKN Mainnet`
  String get nkn_mainnet {
    return Intl.message('NKN Mainnet', name: 'nkn_mainnet', desc: '', args: []);
  }
  ...
  String get my_wallets {
    return Intl.message('My Accounts', name: 'my_wallets', desc: '', args: []);
  }
  ...
  String get go_backup {
    return Intl.message('Go Backup', name: 'go_backup', desc: '', args: []);
  }

  /// `Private Key`
  String get private_key {
    return Intl.message('Private Key', name: 'private_key', desc: '', args: []);
  }

  /// `Public Key`
  String get public_key {
    return Intl.message('Public Key', name: 'public_key', desc: '', args: []);
  }
  ...
  /// `Keystore`
  String get keystore {
    return Intl.message('Keystore', name: 'keystore', desc: '', args: []);
  }
  ...
  /// `Seed`
  String get tab_seed {
    return Intl.message('Seed', name: 'tab_seed', desc: '', args: []);
  }
  ...
  /// `Send To`
  String get send_to {
    return Intl.message('Send To', name: 'send_to', desc: '', args: []);
  }
  ...
  /// `Pay NKN amount`
  String get pay_nkn {
    return Intl.message('Pay NKN amount', name: 'pay_nkn', desc: '', args: []);
  }

  /// `accelerate`
  String get accelerate {
    return Intl.message('accelerate', name: 'accelerate', desc: '', args: []);
  }
  ...
  /// `Send NKN`
  String get send_nkn {
    return Intl.message('Send NKN', name: 'send_nkn', desc: '', args: []);
  }

  /// `Send Eth`
  String get send_eth {
    return Intl.message('Send Eth', name: 'send_eth', desc: '', args: []);
  }
  ...
  /// `Stranger`
  String get stranger {
    return Intl.message('Stranger', name: 'stranger', desc: '', args: []);
  }

  /// `My Contact`
  String get my_contact {
    return Intl.message('My Contact', name: 'my_contact', desc: '', args: []);
  }
  ...
  /// `nMobile`
  String get title {
    return Intl.message('nMobile', name: 'title', desc: '', args: []);
  }

  /// `My Details`
  String get my_details {
    return Intl.message('My Details', name: 'my_details', desc: '', args: []);
  }
  ...
  String get eth_wallet {
    return Intl.message('Eth Account', name: 'eth_wallet', desc: '', args: []);
  }
  ...
  String get enter_topic {
    return Intl.message('Enter topic', name: 'enter_topic', desc: '', args: []);
  }
  ...
  /// `My Group`
  String get my_group {
    return Intl.message('My Group', name: 'my_group', desc: '', args: []);
  }
  ...
  /// `Recently`
  String get recent {
    return Intl.message('Recently', name: 'recent', desc: '', args: []);
  }
  ...
  String get unsubscribe {
    return Intl.message('Leave', name: 'unsubscribe', desc: '', args: []);
  }

  /// `Leaved`
  String get unsubscribed {
    return Intl.message('Leaved', name: 'unsubscribed', desc: '', args: []);
  }

  /// `by`
  String get news_from {
    return Intl.message('by', name: 'news_from', desc: '', args: []);
  }
  ...
  String get chat_tab_group {
    return Intl.message('Group', name: 'chat_tab_group', desc: '', args: []);
  }
  ...
  String get burn_1_minute {
    return Intl.message('1 minute', name: 'burn_1_minute', desc: '', args: []);
  }
  ...
  String get burn_1_hour {
    return Intl.message('1 hour', name: 'burn_1_hour', desc: '', args: []);
  }

  /// `6 hours`
  String get burn_6_hour {
    return Intl.message('6 hours', name: 'burn_6_hour', desc: '', args: []);
  }

  /// `12 hours`
  String get burn_12_hour {
    return Intl.message('12 hours', name: 'burn_12_hour', desc: '', args: []);
  }

  /// `1 day`
  String get burn_1_day {
    return Intl.message('1 day', name: 'burn_1_day', desc: '', args: []);
  }

  /// `1 week`
  String get burn_1_week {
    return Intl.message('1 week', name: 'burn_1_week', desc: '', args: []);
  }
  ...
  /// `Friend`
  String get friends {
    return Intl.message('Friend', name: 'friends', desc: '', args: []);
  }

  /// `Group`
  String get group_chat {
    return Intl.message('Group', name: 'group_chat', desc: '', args: []);
  }
  ...
  /// `Tips`
  String get tip {
    return Intl.message('Tips', name: 'tip', desc: '', args: []);
  }
  ...
  String get storage_text {
    return Intl.message('Storage', name: 'storage_text', desc: '', args: []);
  }
  ...
  /// `inviting`
  String get inviting {
    return Intl.message('inviting', name: 'inviting', desc: '', args: []);
  }

  /// `subscribing`
  String get subscribing {
    return Intl.message('subscribing', name: 'subscribing', desc: '', args: []);
  }
