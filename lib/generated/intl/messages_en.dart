...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accept_invitation": MessageLookupByLibrary.simpleMessage(
      "Accept Invitation",
    ),
    ...
    "accepted_already": MessageLookupByLibrary.simpleMessage(
      "You have already accepted",
    ),
    "account_switching_completed": MessageLookupByLibrary.simpleMessage(
    ...
    "add_user_duplicated": MessageLookupByLibrary.simpleMessage(
    ...
    "authenticate_to_access": MessageLookupByLibrary.simpleMessage(
    ...
    "balance_not_enough": MessageLookupByLibrary.simpleMessage(
      "Balance not enough",
    ),
    ...
    "burn_after_reading": MessageLookupByLibrary.simpleMessage(
      "Burn After Reading",
    ),
    ...
    "change_default_chat_wallet": MessageLookupByLibrary.simpleMessage(
      "Change",
    ),
    "change_language": MessageLookupByLibrary.simpleMessage("Change Language"),
    "channel_invitation": MessageLookupByLibrary.simpleMessage(
      "group invitation",
    ),
    ...
    "click_to_settings": MessageLookupByLibrary.simpleMessage(
      "Click to settings",
    ),
    ...
    "confirm_resend": MessageLookupByLibrary.simpleMessage("Confirm resend?"),
    ...
    "create_channel": MessageLookupByLibrary.simpleMessage(
      "Create/Join to group",
    ),
    "create_ethereum_wallet": MessageLookupByLibrary.simpleMessage(
      "Create Ethereum Account",
    ),
    "create_nkn_wallet": MessageLookupByLibrary.simpleMessage(
      "Create Mainnet Account",
    ),
    "create_private_group": MessageLookupByLibrary.simpleMessage(
    ...
    "d_chat_not_login": MessageLookupByLibrary.simpleMessage(
      "D-Chat not login",
    ),
    ...
    "data_synchronization": MessageLookupByLibrary.simpleMessage(
    ...
    "delete_session": MessageLookupByLibrary.simpleMessage(
      "Delete Conversation",
    ),
    ...
    "developer_options": MessageLookupByLibrary.simpleMessage(
      "developer options",
    ),
    ...
    "error_nkn_address_format": MessageLookupByLibrary.simpleMessage(
      "Invalid wallet address.",
    ),
    "error_required": MessageLookupByLibrary.simpleMessage(
      "This field is required.",
    ),
    "error_seed_format": MessageLookupByLibrary.simpleMessage(
      "Seed format does not match.",
    ),
    "error_tracking": MessageLookupByLibrary.simpleMessage("Error Tracking"),
    "error_unknown_nkn_qrcode": MessageLookupByLibrary.simpleMessage(
      "Unknown NKN qr code.",
    ),
    ...
    "file_not_exist": MessageLookupByLibrary.simpleMessage(
      "The file does not exist",
    ),
    "file_too_big": MessageLookupByLibrary.simpleMessage("The file is too big"),
    "file_too_many": m2,
    ...
    "group_no_exist": MessageLookupByLibrary.simpleMessage(
      "private group no exist",
    ),
    "gwei": MessageLookupByLibrary.simpleMessage("GWEI"),
    "has_left_the_group": MessageLookupByLibrary.simpleMessage("Left group"),
    "help": MessageLookupByLibrary.simpleMessage("Help"),
    "hint_enter_wallet_name": MessageLookupByLibrary.simpleMessage(
      "Enter wallet name",
    ),
    "hours": MessageLookupByLibrary.simpleMessage("hours"),
    "image": MessageLookupByLibrary.simpleMessage("Image"),
    "import_ethereum_wallet": MessageLookupByLibrary.simpleMessage(
      "Import Ethereum Account",
    ),
    "import_nkn_wallet": MessageLookupByLibrary.simpleMessage(
      "Import Mainnet Account",
    ),
    "import_wallet": MessageLookupByLibrary.simpleMessage("Import Account"),
    "import_wallet_as_account": MessageLookupByLibrary.simpleMessage(
      "Import Account",
    ),
    ...
    "import_with_keystore_title": MessageLookupByLibrary.simpleMessage(
    ...
    "import_with_seed_title": MessageLookupByLibrary.simpleMessage(
      "Import with Seed",
    ),
    "input_d_chat_address": MessageLookupByLibrary.simpleMessage(
      "Please input D-Chat ID",
    ),
    "input_keystore": MessageLookupByLibrary.simpleMessage(
      "Please paste keystore",
    ),
    "input_name": MessageLookupByLibrary.simpleMessage("Please input Name"),
    "input_nickname": MessageLookupByLibrary.simpleMessage(
      "Please input Nickname",
    ),
    "input_notes": MessageLookupByLibrary.simpleMessage("Please input Notes"),
    "input_password": MessageLookupByLibrary.simpleMessage(
      "Enter your local password",
    ),
    "input_password_again": MessageLookupByLibrary.simpleMessage(
      "Enter your password again",
    ),
    "input_pubKey": MessageLookupByLibrary.simpleMessage(
    ...
    "invitation_has_expired": MessageLookupByLibrary.simpleMessage(
    ...
    "invitation_signature_error": MessageLookupByLibrary.simpleMessage(
      "invitation signature error",
    ),
    "invite_and_send_success": MessageLookupByLibrary.simpleMessage(
      "invite and send success",
    ),
    "invite_members": MessageLookupByLibrary.simpleMessage("Invite Members"),
    "invite_yourself_error": MessageLookupByLibrary.simpleMessage(
    ...
    "invitee_already_exists": MessageLookupByLibrary.simpleMessage(
    ...
    "kick_yourself_error": MessageLookupByLibrary.simpleMessage(
    ...
    "local_notification": MessageLookupByLibrary.simpleMessage(
      "Local Notification",
    ),
    "local_notification_both_name_message":
        MessageLookupByLibrary.simpleMessage("Display name and message"),
    "local_notification_none_display": MessageLookupByLibrary.simpleMessage(
      "None display",
    ),
    "local_notification_only_name": MessageLookupByLibrary.simpleMessage(
      "Only display name",
    ),
    ...
    "mapped_address": MessageLookupByLibrary.simpleMessage("Mapped address"),
    ...
    "message_debug_info": MessageLookupByLibrary.simpleMessage(
    ...
    "need_microphone_permission": MessageLookupByLibrary.simpleMessage(
      "Need microphone permission",
    ),
    "need_re_subscribe": MessageLookupByLibrary.simpleMessage(
      "Need to re-subscribe",
    ),
    "new_message": MessageLookupByLibrary.simpleMessage("New Message"),
    "new_private_group": MessageLookupByLibrary.simpleMessage(
      "New Private Group",
    ),
    "new_public_group": MessageLookupByLibrary.simpleMessage(
      "New Public Group",
    ),
    ...
    "no_wallet_create": MessageLookupByLibrary.simpleMessage(
      "Create New Account",
    ),
    "no_wallet_desc": MessageLookupByLibrary.simpleMessage(
      "Manage both your Mainnet NKN\n tokens with our smart wallet manager.",
    ),
    "no_wallet_import": MessageLookupByLibrary.simpleMessage(
      "Import Existing Account",
    ),
    "no_wallet_title": MessageLookupByLibrary.simpleMessage(
    ...
    "notification_push": MessageLookupByLibrary.simpleMessage(
      "Notification Push",
    ),
    "notification_push_content": MessageLookupByLibrary.simpleMessage(
      "New Message!",
    ),
    ...
    "private_messages": MessageLookupByLibrary.simpleMessage(
      "Private Messages",
    ),
    ...
    "read_and_agree_terms_01": MessageLookupByLibrary.simpleMessage(
      "read and agree to the ",
    ),
    "read_and_agree_terms_02": MessageLookupByLibrary.simpleMessage(
      "Terms of Service",
    ),
    ...
    "release_to_cancel": MessageLookupByLibrary.simpleMessage(
      "Release to cancel",
    ),
    "remark": MessageLookupByLibrary.simpleMessage("Remark"),
    "remote_notification": MessageLookupByLibrary.simpleMessage(
    ...
    "select_another_wallet": MessageLookupByLibrary.simpleMessage(
      "Select Another Account",
    ),
    "select_asset_to_backup": MessageLookupByLibrary.simpleMessage(
      "Select Asset to Backup",
    ),
    "select_asset_to_receive": MessageLookupByLibrary.simpleMessage(
      "Select Asset to Receive",
    ),
    "select_asset_to_send": MessageLookupByLibrary.simpleMessage(
      "Select Asset to Send",
    ),
    "select_wallet_type": MessageLookupByLibrary.simpleMessage(
      "Select Account Type",
    ),
    ...
    "subscribe_or_waiting": MessageLookupByLibrary.simpleMessage(
    ...
    "tip_password_error": MessageLookupByLibrary.simpleMessage(
      "Wrong password",
    ),
    "tip_switch_success": MessageLookupByLibrary.simpleMessage(
      "Switch Success!",
    ),
    ...
    "topic_resubscribe_enable": MessageLookupByLibrary.simpleMessage(
      "Public group renewal",
    ),
    "topic_subscribe_enable": MessageLookupByLibrary.simpleMessage(
    ...
    "transfer_initiated": MessageLookupByLibrary.simpleMessage(
      "Transfer Initiated",
    ),
    ...
    "verify_wallet_password": MessageLookupByLibrary.simpleMessage(
    ...
    "waiting_for_data_to_sync": MessageLookupByLibrary.simpleMessage(
      "waiting for data to sync",
    ),
    "waiting_for_sync_data": MessageLookupByLibrary.simpleMessage(
    ...
    "you_have_new_message": MessageLookupByLibrary.simpleMessage(
