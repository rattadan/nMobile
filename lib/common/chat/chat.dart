...
class ChatCommon with Tag {
  ...
  Future startInitChecks({int? delay}) async {
    ...
    // Start public group discovery service
    try {
      logger.i("$TAG - Starting public group discovery service");
      await topicCommon.discoveryService.start();
    } catch (e, st) {
      logger.e("$TAG - Error starting discovery service: $e");
      handleError(e, st);
    }
